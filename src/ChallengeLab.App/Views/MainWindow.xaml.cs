...
public partial class MainWindow : Window
{
    ...
    private double _fighterHudFontScale = 1.1;
    private double _aetherHudScale = 1.0;
    private double _aetherHudOpacity = 0.96;
    private double _aetherHudFontScale = 1.1;
